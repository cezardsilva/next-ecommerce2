...
export default function SkeletonCard({ isLoading }: { isLoading?: boolean }) {
    return (
        <div className={clsx(
            ...
            {
                'relative overflow-hidden before:absolute before:inset-0 before:translate-x-full before:animate-[shimmer_1.5s_infinite] before:bg-gradient-to-r before:from-transparent before:via-gray-500/30 before:to-transparent': isLoading,
            }
